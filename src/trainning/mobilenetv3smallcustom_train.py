...
from models.pretrained_model.mobilenetv3smallcustom import build_mobilenetv3_small
...
trainer = Trainer(
    ...
    criterion=criterion,
    optimizer=optimizer,
    checkpoints_dir=str(output_dir / "checkpoints" / "plantdoc" / "pretrain_weight" / "mobilenetv3smallcustom")
)
