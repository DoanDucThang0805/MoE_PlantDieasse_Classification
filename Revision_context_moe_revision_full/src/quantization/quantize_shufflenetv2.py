"""
Static INT8 Quantization for ShuffleNet-V2 x2.0.

Pipeline:
    1. Load ShuffleNet-V2 (torchvision) + checkpoint weights
    2. Export → ONNX FP32
...
def build_model(num_classes: int = 8) -> nn.Module:
    """Create a fresh ShuffleNet-V2 x2.0 instance via torchvision."""
